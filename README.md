...
[![test coverage](https://codecov.io/gh/nikitads9/banner-service-api/branch/dev/graph/badge.svg?token=GWO9GBJDHE)](https://codecov.io/gh/nikitads9/banner-service-api) <br />
...
Вышеперечисленные действия (а к ним вдобавок юнит-тесты и вычисление процента покрытия тестами) можно произвести одной командой:
```bash
make run-tests
```
